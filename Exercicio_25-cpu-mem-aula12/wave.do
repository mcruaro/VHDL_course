...
add wave -noupdate -group CPU -radix unsigned -radixshowbase 0 /testbench/cpu/data_in
...
add wave -noupdate -expand -group RAM -divider READ
add wave -noupdate -expand -group RAM -radix unsigned -radixshowbase 0 /testbench/mem/read_addr
add wave -noupdate -expand -group RAM -radix unsigned -radixshowbase 0 /testbench/mem/data_out
